...
import service.EnQueuedServiceTest
...
@Configuration
trait QueueTestConfiguration {
	
	@Bean
	EnQueuedServiceTest enQueuedService(){
		return new EnQueuedServiceTest()
	}
	...
	Application serviceWithQueue(){
		...
		def javaAdapter = new JavaServiceAdapter(javaClass: 'service.EnQueuedServiceTest', method:'myMethod')

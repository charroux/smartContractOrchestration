package configuration.eventSourcing
...
class EventSourcingConfiguration {
	...
	Application serviceWithEventSourcingAfterService(){
		...
		def scriptAdapter = new ScriptServiceAdapter(file: 'file:src/main/orcha/service/eventSourcing/serviceWithEventSourcingAfterService.js')

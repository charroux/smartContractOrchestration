...
class OrchaLauncherGenerator {
	...
	void generateForLaunching(String xmlSpringContextFileName, String xmlSpringContextQoSFileName){
			...
			orchaLauncherClass.annotate(ImportResource.class).paramArray("value").param("classpath:/" + xmlSpringContextFileName).param("classpath:/" + xmlSpringContextQoSFileName)	
			...
			av1.visit(null, "classpath:/" + xmlSpringContextFileName);
			av1.visit(null, "classpath:/" + xmlSpringContextQoSFileName);
			av1.visitEnd();
	...
	/**
	 * 
	 * @param xmlSpringContextFileName null to generate an empty test launcher
	 * @param xmlSpringContextQoSFileName null to generate an empty test launcher
	 */
	...
	void generateForTesting(String xmlSpringContextFileName, String xmlSpringContextQoSFileName){
			...
			if(xmlSpringContextFileName!=null && xmlSpringContextQoSFileName!=null){
				orchaLauncherClass.annotate(ImportResource.class).paramArray("value").param("classpath:/" + xmlSpringContextFileName).param("classpath:/" + xmlSpringContextQoSFileName)
			} else {
				orchaLauncherClass.annotate(ImportResource.class).paramArray("value")
			}

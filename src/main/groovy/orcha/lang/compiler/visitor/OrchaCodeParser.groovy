 ...
 *
 */
abstract class OrchaCodeParser extends ClassCodeVisitorSupport{
	 ...
	 */
	abstract void depthTraversal(def object, String methodName, InstructionNode node, OrchaCodeParser orchaCodeParser, List<InstructionNode> nodesAlreadyDone)
